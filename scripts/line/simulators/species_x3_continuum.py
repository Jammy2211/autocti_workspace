"""
Simulator: Line With x1 Trap Continuum
======================================
...
"""
dataset_type = "line"
dataset_name = "species_x3_continuum"
...
trap_0 = ac.TrapLogNormalLifetimeContinuum(
    density=0.00006, release_timescale_mu=0.8, release_timescale_sigma=0.05
)
trap_1 = ac.TrapLogNormalLifetimeContinuum(
    density=0.00009, release_timescale_mu=3.5, release_timescale_sigma=0.03
)
trap_2 = ac.TrapLogNormalLifetimeContinuum(
    density=0.00285, release_timescale_mu=20.0, release_timescale_sigma=0.2
)
