...
"""Setup the path to the autocti_workspace, using a relative directory name."""
...
scans = ac.Scans(
    parallel_overscan=ac.Region((1980, 2000, 50, 1980)),
    serial_prescan=ac.Region((0, 2000, 0, 50)),
    serial_overscan=ac.Region((0, 1980, 1980, 2000)),
)
