...
file_path_a = path.join(dataset_path, "j9epf6kjq_rawD.fits")
...
image_aa = aa.acs.ImageACS.from_fits(file_path=file_path, quadrant_letter="D")
...
mat_plot_2d = aplt.MatPlot2D(cmap=aplt.Cmap(vmin=2000.0, vmax=3000.0))
array_plotter = aplt.Array2DPlotter(array=image_aa, mat_plot_2d=mat_plot_2d)
array_plotter.figure_2d()

print(f"Shape of original Extraction D (via autoarray) = {image.shape_native}")
