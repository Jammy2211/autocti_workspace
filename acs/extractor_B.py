...
We will compare this to the already processed quadrant B dataset (which is in different units).
"""
...
print(f"Shape of Bias Extraction B (via autoarray) = {image_aa.shape_native}")
...
print(f"Shape of Bias Extraction B (via autoarray) = {residuals.shape_native}")
